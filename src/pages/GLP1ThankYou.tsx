...
export default function GLP1ThankYou() {
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "#F4EFEA" }}>
      <SEO
        title="Your GLP-1 Guide Is On Its Way"
        description="Check your inbox for access to the Understanding GLP-1 Signaling guide."
        noindex
      />
      <Header />
        ...
        <div className="container-wellness">
          <div className="max-w-xl mx-auto text-center">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-display font-medium mb-6 leading-tight" style={{ color: "#4B2E39" }}>
              Your GLP-1 Guide Is On Its Way
            </h1>
