...
export default function SixMonthCoachingThankYou() {
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <SEO
        title="Welcome — 6-Month Root Cause Transformation"
      ...
      <main className="flex-grow flex items-center justify-center pt-20 md:pt-24 pb-16 md:pb-20">
        <div className="container-wellness">
          <div className="max-w-xl mx-auto text-center">
            <p className="section-label mb-4">6-Month Root Cause Transformation</p>
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-display font-medium text-foreground mb-6 leading-tight">
              You're In — Welcome to the Transformation Support Package
            </h1>
