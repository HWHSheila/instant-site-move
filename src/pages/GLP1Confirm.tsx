...
export default function GLP1Confirm() {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: "#F4EFEA" }}>
      <SEO
        title="Confirm Your Email - GLP-1 Signaling Guide"
        description="Enter your email to receive the Understanding GLP-1 Signaling guide."
        noindex
      />
      <Header />
        ...
        <div className="container-wellness">
          <div className="max-w-xl mx-auto text-center">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              >
                {loading ? "Sending..." : "Access My Guide"}
              </button>
