...
export default function Confirm() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <SEO
        title="Confirm Your Delivery Email"
        description="Enter your email to receive the 30 Day Gut Reset Roadmap."
      />
      <Header />
        ...
        <div className="container-wellness">
          <div className="max-w-xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed mb-10">
              Enter the SAME email you used at checkout to receive your 30 Day Gut Reset Roadmap.
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              >
                {loading ? "Sending..." : "Send My Roadmap"}
              </button>
