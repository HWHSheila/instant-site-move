...
const ctaConfig: Record<string, { href: string; label: string }> = {
  ...
  "protein-nausea-bloating-capacity": {
    href: "/free-guide",
    label: "Get the Free Root Cause Reset Guide",
  },
  "fatigue-is-not-about-effort": {
    href: "/free-guide",
    label: "Get the Free Root Cause Reset Guide",
  },
  "inconsistent-bowel-movements-regulation-signal": {
    href: "/30day-roadmap",
    label: "Get the 30-Day Gut Reset Roadmap",
  },
  "inflammation-is-not-just-aging": {
    href: "/30day-roadmap",
    label: "Get the 30-Day Gut Reset Roadmap",
  },
  "healing-without-restriction": {
    href: "/30day-roadmap",
    label: "Get the 30-Day Gut Reset Roadmap",
  },
  "embarrassed-by-bloating-puffiness": {
    href: "/free-guide",
    label: "Get the Free Root Cause Reset Guide",
  },
  "slow-heavy-delayed-digestion": {
    href: "/30day-roadmap",
    label: "Get the 30-Day Gut Reset Roadmap",
  },
  "women-weight-loss-different-than-men": {
    href: "/free-guide",
    label: "Get the Free Root Cause Reset Guide",
  },
  "heart-palpitations-blood-sugar-drops": {
    href: "/30day-roadmap",
    label: "Get the 30-Day Gut Reset Roadmap",
  },
  "cutting-fat-wont-fix-digestion": {
    href: "/30day-roadmap",
    label: "Get the 30-Day Gut Reset Roadmap",
  },
  "why-stool-changes-with-stress-or-poor-sleep": {
    href: "/free-guide",
    label: "Get the Free Root Cause Reset Guide",
  },
  "why-inflammation-causes-water-retention-in-women": {
    href: "/free-guide",
    label: "Get the Free Root Cause Reset Guide",
  },
  "why-blood-sugar-instability-is-not-just-a-diabetes-problem": {
    href: "/30day-roadmap",
    label: "Get the 30-Day Gut Reset Roadmap",
  },
  "why-you-cant-digest-high-fat-meals-like-you-used-to": {
    href: "/free-guide",
    label: "Get the Free Root Cause Reset Guide",
  },
